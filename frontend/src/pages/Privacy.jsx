    ...
    return (
        <div className="max-w-4xl mx-auto pb-20">
            <div className="bg-white dark:bg-[#1a1b1e] rounded-2xl p-6 md:p-8 shadow-card">
                <h1 className="text-3xl font-bold text-text-main dark:text-white mb-4">{t('legal.privacy.title')}</h1>
                <p className="text-text-secondary dark:text-gray-300 leading-relaxed mb-6">{t('legal.privacy.intro')}</p>
